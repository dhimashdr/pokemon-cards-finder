...
export default function HeroSection(){
    return (
        <div className="flex flex-col md:flex-row pt-10 w-full md:bg-cover md:bg-[url('/assets/bg-image.svg')] justify-center gap-8 md:gap-24 items-center-safe">
            ...
            <div>
                <m.img src='/assets/hero-image.png' className='h-48 lg:h-64 w-fit object-contain' draggable='false' variants={slideLeft} initial='mulai' animate='berhenti' transition={{duration: 0.5, ease: 'linear'}} />
            </div>
        </div>
    )
}